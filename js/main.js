;(function () {
	...
	var clickMenu = function() {
		...
		$('#fh5co-main-nav a, #fh5co-offcanvas a').click(function(event){
			var $this = $(this);
			var href = $this.attr('href');
			var section = $this.data('nav-section');

			// Se o link tem href="#" ou é um link interno com seção, fazer scroll
			if (href === '#' || (section && $('div[data-section="' + section + '"]').length)) {
				if (section && $('div[data-section="' + section + '"]').length) {
					$('html, body').animate({
			...
			// Se é um link externo (outra página), permitir navegação normal
			else if (href && href !== '#') {
				...
				// Permitir navegação normal (não preventDefault)
			}
		});
	};
